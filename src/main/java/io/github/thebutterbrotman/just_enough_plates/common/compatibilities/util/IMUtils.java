package io.github.thebutterbrotman.just_enough_plates.common.compatibilities.util;
...
public class IMUtils {
    public static String jepPrefix(String modid) {
        return MessageFormat.format("jep_{0}", modid);
    }
    ...
    public static void logInterModRegStatus(String modName, String element, boolean isFinished) {
        JustEnoughPlates.LOGGER.info(MessageFormat.format((isFinished) ? LOADED : LOADING, modName, element));
    }
