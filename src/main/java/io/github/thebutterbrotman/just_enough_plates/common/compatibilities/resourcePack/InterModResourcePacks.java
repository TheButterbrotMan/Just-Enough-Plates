...
import static io.github.thebutterbrotman.just_enough_plates.common.compatibilities.util.IMUtils.awpPrefix;
...
public class InterModResourcePacks {
    ...
    public static void lazyRegisterBuiltIn(String modid, String modName) {
        ...
        ResourceManagerHelper.registerBuiltinResourcePack(new Identifier(awpPrefix(modid)), FabricLoader.getInstance().getModContainer(JustEnoughPlates.MOD_ID).orElseThrow(), ResourcePackActivationType.ALWAYS_ENABLED);
